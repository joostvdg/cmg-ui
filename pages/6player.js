...
export default function P6(props) {
    ...
    const defaultInputs = {
        maxInputRangeMin:         320,
        maxInputRangeMax:         400,
        maxInput:                 385,
        minInputRangeMin:         125,
        minInputRangeMax:         195,
        minInput:                 146,
        minResourceInputRangeMin: 45, 
        minResourceInputRangeMax: 80, 
        minResourceInput:         55,
        maxResourceInputRangeMin: 105, 
        maxResourceInputRangeMax: 165, 
        maxResourceInput:         150,
        maxOver300InputRangeMin:  14, 
        maxOver300InputRangeMax:  28, 
        maxOver300Input:          25,
        maxRowInputRangeMin:       1, 
        maxRowInputRangeMax:       6, 
        maxRowInput:               4,
        maxColumnInputRangeMin:    1, 
        maxColumnInputRangeMax:    6, 
        maxColumnInput:            3,
    }
